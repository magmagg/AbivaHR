...
<table class="table table-striped table-bordered table-hover" id="dataTables-example2">
    ...
    ?>
			...
			<tr id="filesarchive<?=$d->archive_id?>">
				...
				<td>
					<div class="btn-group">
						<a href="<?php echo base_url();?>AdminDept/download_one_archive_of_archive/<?=$d->archive_id?>" class="tooltip-info" data-rel="tooltip" title="Download">
						...
						<a href="<?php echo base_url();?>AdminDept/view_one_file/<?=$d->archive_id?>" class="tooltip-info" data-rel="tooltip" title="View">
