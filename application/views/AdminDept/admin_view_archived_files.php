...
<div class="col-xs-12">
            ...
            <?php endforeach;?>
  				...
  				<td>
  					<div class="hidden-sm hidden-xs btn-group">
  						<a href="<?php echo base_url();?>AdminDept/download_one_archive/<?=$d->files_id?>" class="tooltip-info" data-rel="tooltip" title="Download">
  ...
  <!--
  						<a href="<?php echo base_url();?>AdminDept/view_one_file/<?=$d->files_id?>" class="tooltip-info" data-rel="tooltip" title="View">
  						...
  						<div class="hidden-md hidden-lg">
  							<div class="inline pos-rel">
  								...
  								<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
  									<li>
  										<a href="<?php echo base_url();?>AdminDept/download_one_archive/<?=$d->files_id?>" class="tooltip-info" data-rel="tooltip" title="View">
  											<span class="blue">
                        <i class="ace-icon fa fa-download bigger-120"></i>
                      </span>
  										</a>
  ...
  <!--
  									<li>
  										<a href="<?php echo base_url();?>AdminDept/view_one_file/<?=$d->files_id?>" class="tooltip-success" data-rel="tooltip" title="View">
  											<span class="light">
                        <i class="ace-icon fa fa-eye bigger-120"></i>
                      </span>
  										</a>
		...
		swal({
			...
			function(isConfirm) {
				if (isConfirm) {
					$.ajax({
						type: 'POST',
						url: "<?php echo base_url();?>AdminDept/delete_permanently/" + id,
...
<script type="text/javascript">
	$(document).ready(function() {
		$(".filearchive").click(function(e) {
			e.preventDefault();
			var id = $(this).attr("id");
window.open("<?=base_url();?>AdminDept/view_archive_of_archived_files/"+id, "", "width=750,height=500");
		});
	});
</script>
