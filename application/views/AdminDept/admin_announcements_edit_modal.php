    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form" method="POST" id="edit_form" action="<?php echo base_url();?>AdminDept/edit_one_announce">
                  <div class="form-group">
                          <input type="hidden" name="id" id="ann_id" class="col-xs-10 col-sm-5" />
                                  <input type="hidden" name="department" id="department" class="col-xs-10 col-sm-5" />
                      </div>
