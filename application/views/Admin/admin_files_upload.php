...
<div class="row">
	<div class="col-xs-12">
		...
		<div class="col-md-6">
			<form action="<?php echo base_url();?>Admin/do_Upload_files" id="my-awesome-dropzone" method="POST" enctype="multipart/form-data" class="dropzone well">

				<input type="hidden" name="foldername" id="foldername" />
				<input type="hidden" name="maindept" id="maindept" />
		...
		<div class="col-md-6">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<select class="chosen-select form-control" id="form-field-select-3" data-placeholder="Main department" required>
						<option value=""></option>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" placeholder="Please select a department first" name="foldername" disabled="disabled" id="autocomplete" style="width:100%" class="col-xs-10 col-sm-5 typeahead" required/>
					</div>
				</div>
		...
		Dropzone.options.myAwesomeDropzone = { // The camelized version of the ID of the form element
			...
			init: function() {
				...
				this.on("successmultiple", function(files, response) {
					...
					setTimeout(function() {
						location.href = "<?php echo base_url();?>Admin/view_files/" +"1";
					}, 2000);
