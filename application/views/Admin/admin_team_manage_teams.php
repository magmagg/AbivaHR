<div class="row">
	<div class="col-l-12">
		...
		<h3 class="header smaller lighter blue"><a href="#myModal_add" data-toggle="modal"><button class="btn btn-sm btn-success pull-right">Add team</button></a>
Manage teams</h3>
				...
				<tr id="<?=$t->teams_id?>">
					...
					<td>
						...
						<div class="hidden-sm hidden-xs btn-group">
							...
							<a href="#myModal_edit" data-toggle="modal" data-updateid="<?=$t->teams_id?>" data-updatename="<?=$t->teams_name?>" class="tooltip-info" data-rel="tooltip" title="Edit">
							...
							<?php if($t->teams_id == 1):?>
							<?php else:?>
							<a href="#" onclick="foo(<?=$t->teams_id?>)" class="tooltip-info" data-rel="tooltip" title="Delete">
		...
		swal({
			...
			function(isConfirm) {
				if (isConfirm) {
					$.ajax({
						type: 'POST',
						url: "<?php echo base_url();?>Admin/delete_one_team/" + id,
