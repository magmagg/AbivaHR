					...
					<ul class="nav nav-list">
						...
						<li class="<?= ($active_head == 'announcements') ? 'active open':''; ?>">
							...
							<ul class="submenu">
								...
								<li class=" <?= ($active_page == 'announcements_by_dept') ? 'active':''; ?>">
									<a href="<?php echo base_url();?>Admin/announcements_by_dept">
										<i class="menu-icon fa fa-caret-right"></i>
										View by Department
									</a>
									...
									<li class="<?= ($active_head == 'employees') ? 'active open':''; ?>">
										...
										<ul class="submenu">
											...
											<li class=" <?= ($active_page == 'add_employees') ? 'active':''; ?>">
												<a href="<?php echo base_url();?>Admin/add_employees">
													<i class="menu-icon fa fa-caret-right"></i>
													Add Employees
												</a>
						...
						<li class="<?= ($active_head == 'gallery') ? 'active open':''; ?>">
							...
							<ul class="submenu">
								...
								<li class=" <?= ($active_page == 'upload_pictures') ? 'active':''; ?>">
									<a href="<?php echo base_url();?>Admin/upload_pictures">
										<i class="menu-icon fa fa-caret-right"></i>
										Upload pictures
									</a>
								...
								<li class=" <?= ($active_page == 'upload_videos') ? 'active':''; ?>">
									<a href="<?php echo base_url();?>Admin/upload_videos">
										<i class="menu-icon fa fa-caret-right"></i>
										Upload Videos
									</a>
