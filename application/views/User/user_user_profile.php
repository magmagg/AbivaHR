												...
												<div class="tabbable">
													...
													<div class="tab-content profile-edit-tab-content">
														<div id="edit-basic" class="tab-pane in active">
															...
															<form method="POST" action="<?php echo base_url();?>User/submit_edit_one_user" id="userprofile" enctype="multipart/form-data">
															...
															<div class="row">
																...
																<div class="col-xs-12 col-sm-8">
																	<div class="form-group">
																		...
																		<div class="col-sm-8">
																				<input class="col-xs-12 col-sm-10" type="text" placeholder="Username" name="uname" value="<?php echo $this->session->userdata['user_name']; ?>" />
																		</div>
																	</div>
																	...
																	<div class="form-group">
																		...
																		<div class="col-sm-8">
																			<input class="col-xs-12 col-sm-10" type="text" id="firstname" name="fname" value="<?php echo $this->session->userdata['firstname']; ?>" />
																		</div>
																	</div>
																	<div class="form-group">
																	...
																	<div class="form-group">
																		...
																		<div class="col-sm-8">
																			<input class="col-xs-12 col-sm-10" type="text" id="lastname" name="lname" value="<?php echo $this->session->userdata['lastname']; ?>" />
																		</div>
																	</div>
																</div>
															</div>
															...
															<div class="form-group">
																...
																<div class="col-sm-9">
																	<textarea style="width: 75%; height: 150px;" name="aboutme"><?php echo $AboutMe?></textarea>
																</div>
															</div>
														...
														<form method="POST" action="<?php echo base_url();?>User/change_password" id="change_password" >
															<!-- IMPORTANT LINE OF CODE!!! -->
