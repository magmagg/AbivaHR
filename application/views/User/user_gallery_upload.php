<div class="row">
	<div class="col-xs-12">
		...
		<br>
		<br>
		<form action="<?php echo base_url();?>User/do_Upload_gallery" id="my-awesome-dropzone" method="POST" enctype="multipart/form-data" class="dropzone well">
	...
	Dropzone.options.myAwesomeDropzone = { // The camelized version of the ID of the form element
		...
		init: function() {
			...
			this.on("successmultiple", function(files, response) {
				...
				setTimeout(function() {
					location.href = "<?php echo base_url();?>User/view_gallery/" + response;
				}, 2000);
