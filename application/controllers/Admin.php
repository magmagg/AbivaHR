...
//========================DASHBOARD=====================//
  ...
  function view_other_profile()
  {
    ...
    $ID = $this->uri->segment(3);
      ...
      //var_dump($this->session->all_userdata());
    $this->load->view('Admin/admin_header',$header);
    $this->load->view('Admin/admin_view_other_profile',$data);
  }
  //============================MESSAGES===================================//
  function messages()
  {
...
var_dump($error);
  ...
  function do_upload_files()
  {
    ...
    if($hasunread)
      ...
      $header['ihasunread'] = 0;
    $data['files'] = $this->Admin_model->get_deleted_archive();
    $data['users'] = $this->Admin_model->get_users();
    $data['departments'] = $this->Admin_model->get_departments();
  ...
  function download_one_archive()
  {
    ...
    $data['file'] = $this->Admin_model->get_one_deleted_archive($id);
  ...
  function delete_one_file()
  {
    ...
    $archiveid = $this->Admin_model->insert_tblfiles_deleted($data);
    }
    ...
    foreach($data['archive'] as $d)
    {
      ...
      $this->Admin_model->insert_tblfiles_archive_deleted($data);
    }
