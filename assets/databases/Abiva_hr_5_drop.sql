...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 01, 2016 at 02:50 AM
...
INSERT INTO `tblannouncements` (`ann_id`, `ann_title`, `ann_content`, `ann_timestamp`) VALUES
(1, 'Hello', 'hi', '2016-08-18 03:48:41'),
(2, 'hello', 'world ', '2016-08-31 04:48:12'),
(4, 'Hello', 'ss ', '2016-08-31 07:11:53');
...
--
-- Dumping data for table `tblannouncements_visible`
--

INSERT INTO `tblannouncements_visible` (`ann_id_fk`, `ann_department_fk`) VALUES
(1, 1),
(1, 2),
(1, 3),
(1, 4),
...
--
-- Dumping data for table `tblfiles_content`
--

INSERT INTO `tblfiles_content` (`files_id`, `files_name`, `files_path`, `files_display_name`, `files_version`, `files_ffolder_id_fk`, `files_active`) VALUES
(1, 'PrimePack Requirements.docx', 'C:\\xampp\\htdocs\\AbivaHR\\assets\\files\\documents\\Requirements\\PrimePack Requirements.docx', 'Primepack Requirements', '1.0', 1, 1),
(2, 'PrimePack specific requirement', 'C:\\xampp\\htdocs\\AbivaHR\\assets\\files\\documents\\Requirements\\PrimePack specific requirements.docx', 'Primepack Specific Requirements', '1.0', 1, 1),
(4, 'feelinpines.jpg', 'C:\\xampp\\htdocs\\AbivaHR\\assets\\files\\documents\\Feel\\feelinpines.jpg', 'Feelinpines', '1.0', 2, 1),
(5, 'ITE-1-1617.xlsx', 'C:\\xampp\\htdocs\\AbivaHR\\assets\\files\\documents\\Feel\\ITE-1-1617.xlsx', 'Ite-1-1617', '1.0', 2, 1),
(6, 'PrimePack Requirements.docx', 'C:\\xampp\\htdocs\\AbivaHR\\assets\\files\\documents\\d\\PrimePack Requirements.docx', 'Primepack Requirements', '1.0', 3, 1),
(7, 'PrimePack specific requirement', 'C:\\xampp\\htdocs\\AbivaHR\\assets\\files\\documents\\folder\\PrimePack specific requirements.docx', 'Primepack Specific Requirements', '1.0', 4, 1),
(8, 'PrimePack specifications.docx', 'C:\\xampp\\htdocs\\AbivaHR\\assets\\files\\documents\\folder\\PrimePack specifications.docx', 'Primepack Specifications', '1.0', 4, 1);
...
--
-- Dumping data for table `tblfiles_folder`
--

INSERT INTO `tblfiles_folder` (`ffolder_id`, `ffolder_name`, `ffolder_dept_id_fk`) VALUES
(1, 'Requirements', 3),
(2, 'Feel', 2),
(3, 'd', 3),
(4, 'folder', 1);
...
--
-- Dumping data for table `tblfiles_shared`
--

INSERT INTO `tblfiles_shared` (`shared_id`, `shared_ffolder_id_fk`, `shared_dept_id_fk`) VALUES
(1, 1, 2),
(2, 2, 4),
(3, 3, 3),
(4, 4, 4),
...
--
-- Dumping data for table `tblgallery_folder`
--

INSERT INTO `tblgallery_folder` (`gfolder_id`, `gfolder_name`) VALUES
(1, 'Stack overflow'),
(2, 'Feels');
...
--
-- Dumping data for table `tblgallery_pictures`
--

INSERT INTO `tblgallery_pictures` (`picture_id`, `picture_name`, `picture_path`, `gfolder_id_fk`) VALUES
(1, 'stackoverflow1.PNG', 'C:\\xampp\\htdocs\\AbivaHR\\assets\\files\\gallery\\Stack overflow\\stackoverflow1.', 1),
(2, 'Stackoverflow2.PNG', 'C:\\xampp\\htdocs\\AbivaHR\\assets\\files\\gallery\\Stack overflow\\Stackoverflow2.', 1),
(3, 'StackOverflowTop.PNG', 'C:\\xampp\\htdocs\\AbivaHR\\assets\\files\\gallery\\Stack overflow\\StackOverflowTo', 1),
(4, 'feelinpines.jpg', 'C:\\xampp\\htdocs\\AbivaHR\\assets\\files\\gallery\\Feels\\feelinpines.jpg', 2);
...
--
ALTER TABLE `tblfiles_folder`
  MODIFY `ffolder_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `tblfiles_shared`
--
ALTER TABLE `tblfiles_shared`
  MODIFY `shared_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT for table `tblgallery_folder`
--
ALTER TABLE `tblgallery_folder`
  MODIFY `gfolder_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
